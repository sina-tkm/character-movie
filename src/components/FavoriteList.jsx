...
function FavoriteList({favorite,favebox,onDelete}) {
  return (
...
<div className="flex item-center justify-between border-b-2"> 
    ...
    <XMarkIcon onClick={favebox} className="h-[30px] w-[30px] text-red-400"/>
</div>
    <div className="flex gap-y-3 flex-col">
        {favorite.map((item)=>{
            return(
        <div key={item.id} className="flex mx-auto pb-2  gap-x-4  justify-between relative w-[90%] pt-[12px] border-b-2 item-center"> 
